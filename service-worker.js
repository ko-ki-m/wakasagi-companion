const CACHE_NAME = 'wakasagi-loglink-map-v11';
const ASSETS = ['./','./index.html?v=11','./style.css?v=11','./app.js?v=11','./manifest.webmanifest?v=11','./reset.html','./icon-192.png','./icon-512.png'];
