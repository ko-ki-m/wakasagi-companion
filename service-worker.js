const CACHE_NAME = 'wakasagi-loglink-map-v115';
const ASSETS = ['./','./index.html?v=115','./style.css?v=115','./app.js?v=115','./manifest.webmanifest?v=115','./reset.html','./force-v1121.html','./icon-192.png','./icon-512.png'];
