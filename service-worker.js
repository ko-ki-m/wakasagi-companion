const CACHE_NAME = 'wakasagi-loglink-map-v1121';
const ASSETS = ['./','./index.html?v=1121','./style.css?v=1121','./app.js?v=1121','./manifest.webmanifest?v=1121','./reset.html','./force-v1121.html','./icon-192.png','./icon-512.png'];
