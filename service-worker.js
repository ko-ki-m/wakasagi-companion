const CACHE_NAME = 'wakasagi-loglink-map-v113';
const ASSETS = ['./','./index.html?v=113','./style.css?v=113','./app.js?v=113','./manifest.webmanifest?v=113','./reset.html','./force-v1121.html','./icon-192.png','./icon-512.png'];
