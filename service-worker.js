const CACHE_NAME = 'wakasagi-loglink-map-v111';
const ASSETS = ['./','./index.html?v=111','./style.css?v=111','./app.js?v=111','./manifest.webmanifest?v=111','./reset.html','./icon-192.png','./icon-512.png'];
