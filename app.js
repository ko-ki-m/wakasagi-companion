...
const DB_NAME = 'wakasa_companion_v1';
const DB_VER = 1;
...
async function exportDb(){
  const spots=await getAllSpots();
  downloadBlob(`wakasa_spots_${nowMs()}.json`,'application/json',JSON.stringify({exported_ms:nowMs(),version:1,spots},null,2));
}
